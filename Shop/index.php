		...
		<div class="header">
			<div class="grid wide">
				<div class="header-main">
					...
					<div class="contact">
						<p>Hotline: 0375911174</p>
						<p>Email: <a href="mailto:Chuanghost203@gmail.com" style="color: #333;">Chuanghost203@gmail.com</a></p>
					</div>
				</div>
			</div>
		</div>
...
<div><marquee behavior="alternate" class="chaychu" >Chào mừng quý khách đến với cửa hàng NDCSHOP Shoes. Chúc quý khách một ngày tốt lành.</marquee></div><br>
		...
		<div class="footer">
			...
			<div class="footer__bottom">
				<div class="grid wide">
					<p>© 2024 - Bản quyền thuộc về NDCSHOP Shoes</p>
				</div>
			</div>
		</div>
